        ...
        for single_data in data_file:
            ...
            if single_data.strip() != "":
                ...
                if data_array[5] == "DELETED":
                    ...
                    print(data_array[0] +"  | "+ data_array[1] +"  | "+ data_array[2] +"  | "+ data_array[3] +"  | "+ data_array[4] +"\n")
                    break
    ...
    if id != "":
        ...
        for single_data in data_file:
            ...
            if single_data.strip() != "":
                data_array = single_data.split("#")
                if data_array[0] == id:
                    # print("Line Number : " + str(line_number -1))
                    # del lines[line_number - 1]
                    lines[line_number - 1] = data_array[0] +"#"+ data_array[1] +"#"+ data_array[2] +"#"+ data_array[3] +"#"+ data_array[4]+"#DELETED\n"
                    # print("ID " + str(line_number - 1) + " has been deleted.")
...
def save_data():
    ...
    if first_name.strip() == "":
        ...
        # print("ID : " +str(new_student.get_id()))
...
def show_option():
    ...
    if option_data == "1": 
        ...
        view_data()
        show_option()
    elif option_data == "5": print("You choosed 5")
    elif option_data == "0": exit
    else: 
